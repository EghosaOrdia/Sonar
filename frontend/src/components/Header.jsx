    ...
    >
      <div class="mx-auto max-w-6xl px-4 sm:px-6 transition-all duration-500 ">
        <div class="flex items-center justify-between rounded-full px-4 sm:px-5 py-2.5 transition-all duration-500 border border-transparent">
          ...
          >
            <span class="relative inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#1DB954]/10 ring-1 ring-[#1DB954]/30">
              <Music2 size={20} className="text-[#1DB954]" />
              <span class="absolute inset-0 rounded-lg bg-[#1DB954]/10 blur-md -z-10"></span>
            </span>
            <span class="font-display text-lg font-semibold tracking-tight text-white">
              Sonar
            </span>
            <span class="ml-1 hidden sm:inline-flex text-[10px] font-mono-plex uppercase tracking-[0.18em] text-zinc-500">
              v0.4 beta
            </span>
          </a>
          ...
          <button
            data-testid="connect-spotify-nav"
            class="group inline-flex items-center gap-2 rounded-full bg-[#1DB954] hover:bg-[#1ED760] text-black font-semibold text-sm px-4 py-2 transition-all hover:shadow-[0_8px_24px_rgba(29,185,84,0.35)]"
          >
