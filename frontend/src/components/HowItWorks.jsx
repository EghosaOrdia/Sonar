      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-start max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight text-white">
            ...
            <span> </span>
            <span className="text-[#1DB954]">four steps.</span>
          </h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div
            ...
            className="sonar-card relative p-6 sm:p-7 overflow-hidden group"
          >
            <div className="absolute top-6 right-6 text-[10px] font-mono-plex tracking-[0.2em] text-zinc-600">
              01
            </div>
            <div className="relative h-11 w-11 rounded-xl bg-[#1DB954]/10 border border-[#1DB954]/20 grid place-items-center">
              <FolderSearch2 className="h-5 w-5 text-[#1DB954]" />
              <span className="absolute -inset-2 -z-10 rounded-2xl opacity-0 group-hover:opacity-100 blur-xl transition-opacity how-iconbox"></span>
            </div>
            ...
            <span
              aria-hidden="true"
              className="hidden lg:block absolute top-1/2 -right-4 h-px w-8 bg-linear-to-r from-white/10 to-transparent"
            ></span>
          </div>
          <div
          ...
          >
            ...
            <div className="relative h-11 w-11 rounded-xl bg-[#1DB954]/10 border border-[#1DB954]/20 grid place-items-center">
              ...
              <span
                aria-hidden="true"
                className="absolute -inset-2 -z-10 rounded-2xl opacity-0 group-hover:opacity-100 blur-xl transition-opacity how-iconbox"
              ></span>
            </div>
            <h3 className="mt-5 font-display text-lg text-white">
              Read metadata
